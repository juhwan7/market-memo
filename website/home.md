...
<div class="mm-stat"><strong>{{DOC_COUNT}}</strong><span>전체 분석</span></div>
...
<span class="mm-section-lead">새로 추가되거나 핵심 판단이 바뀐 문서부터 봅니다.</span>

{{RECENT_DOCS}}

## 분류

<div class="mm-section-list" markdown>

<div class="mm-section-item" markdown>
<span class="mm-section-no">01</span>

### 시황

시장 방향을 만든 변수, 수급, 환율, 선물과 다음 거래일 체크포인트.

[시황 전체 보기 →](시황/)
</div>

<div class="mm-section-item" markdown>
<span class="mm-section-no">02</span>

### 산업·테마

테마가 왜 생겼는지, 실제 수요·공급망·정책과 수혜 강도를 구분.

[산업·테마 전체 보기 →](산업-테마/)
</div>

<div class="mm-section-item" markdown>
<span class="mm-section-no">03</span>

### 종목·기업

회사가 무엇으로 돈을 버는지, 최근 주가 촉매와 실적 연결을 확인.
...
<span class="mm-section-lead">읽은 자료와 다시 볼 자료만 가볍게 표시합니다. 상태는 이 브라우저에만 저장됩니다.</span>
...
<span class="mm-section-lead">CPI·PPI·FOMC처럼 시장 전체 방향을 바꿀 수 있는 일정만 추립니다.</span>

{{SCHEDULE_DOCS}}

<div class="mm-home-note" markdown>

**작성 원칙**  
공시·정부·기업 원문을 우선 확인하고, **[확정] / [시장 기대] / [추정]**을 구분합니다. 이 사이트는 개인 학습·시장 분석용이며 투자 권유가 아닙니다.
